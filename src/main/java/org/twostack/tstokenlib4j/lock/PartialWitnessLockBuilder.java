 ...
 * script template from {@code templates/nft/pp3_witness.json} and performs raw hex
 ...
 */
public class PartialWitnessLockBuilder extends LockingScriptBuilder {

    private final byte[] ownerPKH;

    /**
     * Creates a new PP3 NFT partial-witness lock builder.
     *
     ...
     */
    public PartialWitnessLockBuilder(byte[] ownerPKH) {
    ...
    /**
     * Builds the PP3 NFT partial-witness locking script by loading the template from
     * {@code templates/nft/pp3_witness.json} and substituting the {@code {{ownerPKH}}}
    ...
    public Script getLockingScript() {
        TemplateDescriptor td = TemplateLoader.load("templates/nft/pp3_witness.json");
